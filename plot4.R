...
with(sub_data, plot(DateTime,Global_active_power,xlab = '',
                    ylab = 'Global Active Power (kilowatts)',type ='l'))

#plot:2
with(sub_data, plot(DateTime,Voltage,xlab = 'datetime',
                    ylab = 'Voltage',type ='l'))
#plot:3
...
with(sub_data, plot(DateTime,Global_reactive_power,xlab = 'datetime',type ='l'))
